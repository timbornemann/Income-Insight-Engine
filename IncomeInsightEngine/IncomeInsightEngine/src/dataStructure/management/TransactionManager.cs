...
namespace IncomeInsightEngine.src.dataStructure.management
{
    ...
    {   
        ...
        /// <summary>
        /// Calculates the total amount of all transactions in the collection.
        /// </summary>
        /// <returns>The total amount as a decimal.</returns>
        /// <remarks>
        /// This method sums the amounts of all transactions within the current collection. It leverages the overloaded CalculateTotalAmount method
        /// that takes a list of transactions as a parameter, providing a straightforward way to obtain the total amount of all transactions.
        /// </remarks>
        ...
        /// <summary>
        /// Calculates the total income from all transactions in the collection.
        /// </summary>
        /// <returns>The total income as a decimal.</returns>
        /// <remarks>
        /// This method computes the sum of the amounts of all transactions considered as income within the current collection. It leverages the CalculateTotalIncome method
        /// that takes a list of transactions as a parameter, allowing for a focused calculation on transactions classified as income.
        /// </remarks>
        ...
        /// <summary>
        /// Calculates the total expenses from all transactions in the collection.
        /// </summary>
        /// <returns>The total expenses as a decimal.</returns>
        /// <remarks>
        /// This method computes the sum of the amounts of all transactions considered as expenses within the current collection. It utilizes the CalculateTotalExpenses method
        /// that takes a list of transactions as a parameter, facilitating a focused calculation on transactions classified as expenses by considering transactions with negative amounts.
        /// </remarks>
